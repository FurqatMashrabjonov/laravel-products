...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{ asset('public/plugins/OwlCarousel2-2.2.1/owl.theme.default.css') }}">
                    ...
                    <div class="header_search">
                        <form action="{{route('home')}}" id="header_search_form" method="get">
                            ...
                            <button type="button" class="header_search_button" value="Search"><img
                                    src="{{ asset('public/images/search.png') }}" alt=""></button>
                        </form>
                    </div>
                    @endif

                    <!-- Cart -->
                    <div class="cart"><a href="{{route('cart')}}">
                            <div><img class="svg" src="{{ asset('public/images/cart.svg') }}"
                                      alt="https://www.flaticon.com/authors/freepik"></div>
                        </a></div>
                    <!-- Phone -->
                    <div class="header_phone d-flex flex-row align-items-center justify-content-start">
                        <div>
                            <div><img src="{{ asset('public/images/phone.svg') }}"
                                      alt="https://www.flaticon.com/authors/freepik"></div>
                        </div>
                                    ...
                                    <a href="#">
                                        <div class="d-flex flex-row align-items-center justify-content-start">
                                            <div class="footer_logo_icon"><img
                                                    src="{{ asset('public/images/logo_2.png') }}" alt=""></div>
                                            <div>Little Closet</div>
                                        </div>
                                    </a>
                                </div>
