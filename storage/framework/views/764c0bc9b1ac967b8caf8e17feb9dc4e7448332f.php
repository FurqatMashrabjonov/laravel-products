...
<head>
    ...
    <link href="<?php echo e(asset('public/plugins/font-awesome-4.7.0/css/font-awesome.min.css')); ?>" rel="stylesheet"
          type="text/css">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/plugins/OwlCarousel2-2.2.1/owl.carousel.css')); ?>">
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('public/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')); ?>">
                ...
                <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                    ...
                    <div class="header_search">
                        <form action="<?php echo e(route('home')); ?>" id="header_search_form" method="get">
                            ...
                            <button type="button" class="header_search_button" value="Search"><img
                                    src="<?php echo e(asset('public/images/search.png')); ?>" alt=""></button>
                        </form>
                    </div>
                    <?php endif; ?>

                    <!-- Cart -->
                    <div class="cart"><a href="<?php echo e(route('cart')); ?>">
                            <div><img class="svg" src="<?php echo e(asset('public/images/cart.svg')); ?>"
                                      alt="https://www.flaticon.com/authors/freepik"></div>
                        </a></div>
                    <!-- Phone -->
                    <div class="header_phone d-flex flex-row align-items-center justify-content-start">
                        <div>
                            <div><img src="<?php echo e(asset('public/images/phone.svg')); ?>"
                                      alt="https://www.flaticon.com/authors/freepik"></div>
                        </div>
                                    ...
                                    <a href="#">
                                        <div class="d-flex flex-row align-items-center justify-content-start">
                                            <div class="footer_logo_icon"><img
                                                    src="<?php echo e(asset('public/images/logo_2.png')); ?>" alt=""></div>
                                            <div>Little Closet</div>
                                        </div>
                                    </a>
                                </div>
                                <div class="footer_about_text" style="text-align: justify;">
                                    <p>Little Closet - небольшой магазин стильный и универсальных вещей на каждый день.
                                        Мы позаботились о том, чтобы любой наш покупатель остался доволен нашими
                                        ценамами, качеством товаров и сервисом обслуживания.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer_contact">
                                ...
                                <div class="newsletter">
                                    <form action="" method="" id="newsletter_form" class="newsletter_form">
                                        <input type="text" name="newsletter_input_message"
                                               class="newsletter_input message" placeholder="Ваше сообщение">
                                        <input type="text" name="newsletter_input_email" class="newsletter_input email"
                                               placeholder="Ваш контакт(email, skype,...)">
                                        <br>
                                        <button type="button" class="newsletter_button">></button>
                                        <br>
                        ...
                        <div class="col">
                            <div
                                ...
                                <div class="copyright order-md-1 order-2">
                                    ...
                                    All rights reserved | This site is made with <i class="fa fa-heart-o"
                                                                                    aria-hidden="true"></i> by <a
                                        href="#">WEB-STUDIO "25one"</a>
                                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                </div>
                            </div>
                        </div>
